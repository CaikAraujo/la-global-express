                    ...
                    <div className="bg-white py-10 px-8 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-100">
                        ...
                        <div className="mb-8 text-center">
                            ...
                            <h2 className="text-2xl font-bold tracking-tight text-slate-900">
                                {accountType === 'individual' ? 'Crie sua conta pessoal' : 'Cadastro Corporativo'}
                            </h2>
                            <p className="mt-2 text-sm text-slate-500">
                                {accountType === 'individual'
                                    ? 'Junte-se a nós e comece a agendar serviços'
                                    : 'Cadastre sua empresa para soluções exclusivas'
                                }
                            </p>
                        </div>
                            ...
                            {accountType === 'individual' ? (
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label htmlFor="firstName" className="block text-sm font-semibold text-slate-700 mb-2">Nome</label>
                                        ...
                                        <div>
                                            <label htmlFor="lastName" className="block text-sm font-semibold text-slate-700 mb-2">Sobrenome</label>
                                ...
                                >
                                    <div>
                                        <label htmlFor="companyName" className="block text-sm font-semibold text-slate-700 mb-2">Nome da Empresa</label>
                                    ...
                                    <div>
                                        <label htmlFor="companyUid" className="block text-sm font-semibold text-slate-700 mb-2">UID / NIDE (Registro Suíço)</label>
                                    ...
                                    <div>
                                        <label htmlFor="contactPerson" className="block text-sm font-semibold text-slate-700 mb-2">Pessoa de Contato</label>
                                    ...
                                    <div>
                                        ...
                                        <input id="email" name="email" type="email" required placeholder="contato@empresa.ch" className="block w-full rounded-lg border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-brand-500 focus:bg-white focus:ring-brand-500 transition-all duration-200 sm:text-sm" />
                                    </div>
                                    ...
                                    <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg text-sm text-blue-800 flex items-start gap-2">
                                        ...
                                        <div>Este cadastro passará por análise. Você receberá a confirmação em até 24h.</div>
                                    </div>

                                    <button type="submit" disabled={loading} className="flex w-full justify-center items-center gap-2 rounded-lg bg-brand-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-600/20 hover:bg-brand-700 hover:shadow-brand-600/30 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed transform hover:-translate-y-0.5">
                                        {loading ? <Loader2 className="animate-spin" /> : 'Solicitar Cadastro Empresarial'}
                                    </button>
                                </motion.form>
                            )}
                        </AnimatePresence>
