        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10 relative z-10">
            ...
            <div className="pt-8 flex flex-col sm:flex-row gap-4">
              <a 
                href="#servicos"
                className="inline-flex justify-center items-center bg-brand-600 text-white font-bold py-4 px-10 text-sm uppercase tracking-widest hover:bg-black transition-all"
              >
                Nossos Serviços
              </a>
              <a 
                href="#contato"
                className="inline-flex justify-center items-center bg-white text-gray-900 border-2 border-gray-900 font-bold py-4 px-10 text-sm uppercase tracking-widest hover:bg-gray-50 transition-all"
              >
                Fale Conosco
              </a>
            </div>
          ...
          <div className="relative h-[500px] lg:h-[600px] w-full">
            ...
            <img 
              ...
              className="w-full h-full object-cover shadow-2xl relative z-10 grayscale-[20%] contrast-125"
            />
